...
def evaluate_model(y_true,y_pred, title:str="Model evaluation") -> dict:
    ...
    print(f"R2 score (coefficient of details): {r2}")

    return{'mae':mae,'rmse':rmse,'r2':r2}

def plot_prediction(y_true,y_pred, save_path: str=None):
    """
    ...
    axes[0].set_ylabel('Predict salary(USD)')
...
def print_observations(metrics: dict):
    """
    Print observation based on model metrics
    """
    mae = metrics['mae']
    r2 = metrics['r2']
